...
- **Coding a Tensor Library** (500 lines) -- Moving from scalars to multi-dimensional arrays, this project builds a fully-featured Tensor library. You'll create a powerful Tensor object ([tensor.py](https://github.com/atalw/fromthetensor/blob/main/lilgrad/lilgrad/tensor.py)) with common tensor operations `expand`, `permute`, `pad`, `cat`, `squeeze`, `slice`, `conv2d`, `batchnorm`, `layernorm`, etc.
